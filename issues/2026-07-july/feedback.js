...
(function () {
  ...
  var css = [
    ...
    '#upad-fb-modal{background:#fff;border:1px solid #aaa;padding:14px 16px 16px;width:100%;max-width:318px;font-family:"Times New Roman",Times,serif;font-size:13px;color:#000;line-height:1.55;position:relative;box-shadow:0 6px 28px rgba(0,0,0,0.32);}',
    ...
    '#upad-fb-title{font-size:14px;font-weight:bold;color:#000;margin-bottom:4px;padding-right:22px;}',
    '#upad-fb-edition{font-size:10px;color:#000;font-weight:600;margin-bottom:10px;font-style:italic;border-bottom:1px solid #e5e5e5;padding-bottom:8px;}',
    '#upad-fb-q-loading{color:#000;font-style:italic;margin-bottom:10px;}',
    ...
    '.upad-fb-label{display:block;color:#000;margin-bottom:2px;margin-top:9px;}',
    '.upad-fb-opt{color:#555;font-size:10px;margin-left:2px;}',
